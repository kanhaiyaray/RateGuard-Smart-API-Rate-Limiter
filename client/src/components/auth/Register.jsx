  ...
  return (
    <div className="max-w-md mx-auto">
      <div className="glass rounded-2xl p-8 border border-white/5">
        ...
        <p className="text-gray-400 text-center text-sm mt-1">Start using the API rate limiter</p>
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <button
            type="submit"
            className="w-full py-3 rounded-xl bg-emerald-600 hover:bg-emerald-700 transition font-medium text-white shadow-lg shadow-emerald-600/20"
          >
