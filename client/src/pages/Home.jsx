    ...
    <div className="min-h-[60vh] flex flex-col items-center justify-center text-center py-20">
      ...
      {user ? (
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-8">
          <Link
            to="/login"
            className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl bg-blue-600 hover:bg-blue-700 transition font-medium text-white shadow-lg shadow-blue-600/20 hover:shadow-blue-600/40 transform hover:scale-105 transition-all duration-200"
          >
